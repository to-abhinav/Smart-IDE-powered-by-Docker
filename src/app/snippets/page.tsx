...
function SnippetsPage() {
  ...
  const filteredSnippets = snippets.filter(snippets => {
    const matchesSearch = snippets.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
      snippets.language.toLowerCase().includes(searchQuery.toLowerCase()) || snippets.userName.toLowerCase().includes(searchQuery.toLowerCase())

    const matchesLanguage = !selectedLanguage || snippets.language === selectedLanguage
